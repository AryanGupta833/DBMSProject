...
public class SalesService {
    ...
    public static void viewSales(){
        try {
            ...
            String query = "SELECT s.sales_id, s.sales_price, s.sales_date, b.client_name AS buyer, se.client_name AS seller, a.name AS agent, p.address FROM sales s JOIN client b ON s.buyer_id = b.client_id JOIN client se ON s.seller_id = se.client_id JOIN agent a ON s.agent_id = a.agent_id JOIN property p ON s.property_id = p.property_id";
            PreparedStatement ps = conn.prepareStatement(query);
